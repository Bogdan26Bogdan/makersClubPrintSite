...
class Database: 
    ...
    def _get_client(self) -> None: 
        ...
        uri = f"mongodb+srv://{self.user}:{self.password}@makersclub-testing.fgocnhe.mongodb.net/?retryWrites=true&w=majority"
    ...
    def _connect_to_db(self, database: str = DATABASE_NAME) -> None:
        ...
        if self.client == None: self._get_client()
        self.db = client[f'{database}']
    ...
    def _check_connections(self) -> None: 
        ...
        if self.db == None: self._connect_to_db()
    ...
    def find_object(self, collection: str, primary_key: dict, return_values: dict = None) -> list[dict]:
